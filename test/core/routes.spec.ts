...
describe("resolveSecureRoute full matrix", () => {
  it.each([
    ...
    ["/api/login", { kind: "api", api: "auth-login" }],
    ["/api/logout", { kind: "api", api: "auth-logout" }],
    ["/api/setup", { kind: "api", api: "auth-setup" }],
    ["/api/auth/login", { kind: "api", api: "auth-login" }],
    ["/api/auth/logout", { kind: "api", api: "auth-logout" }],
    ["/api/auth/setup", { kind: "api", api: "auth-setup" }],
    ["/api/auth/password", { kind: "api", api: "auth-password" }],
